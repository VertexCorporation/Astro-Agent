...
export const MODELS = {
	...
	"github-copilot": {
		"claude-fable-5": {
			...
			headers: {"User-Engine":"GitHubCopilotChat/0.35.0","Editor-Version":"vscode/1.107.0","Editor-Plugin-Version":"copilot-chat/0.35.0","Copilot-Integration-Id":"vscode-chat"},
	...
	"kimi-coding": {
		"k2p6": {
			...
			headers: {"User-Engine":"KimiCLI/1.5"},
			reasoning: true,
			input: ["text", "image"],
			cost: {
				input: 0,
