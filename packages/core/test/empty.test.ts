...
describe("Core Providers Empty Message Tests", () => {
	...
	describe.skipIf(!process.env.XCore_API_KEY)("xCore Provider Empty Messages", () => {
	...
	describe.skipIf(!hasCloudflareWorkersCoreCredentials())("Cloudflare Workers Core Provider Empty Messages", () => {
	...
	describe.skipIf(!hasCloudflareAiGatewayCredentials())("Cloudflare Core Gateway Provider Empty Messages", () => {
	...
	describe.skipIf(!process.env.ZCore_API_KEY)("zCore Provider Empty Messages", () => {
	...
	describe.skipIf(!process.env.Core_GATEWAY_API_KEY)("Vercel Core Gateway Provider Empty Messages", () => {
