 ...
 *
 * Regression test for: https://github.com/badlogic/Astro-Agent/issues/1022
 */
...
describe("Tool Call ID Normalization - Prefilled Context", () => {
	...
	function buildPrefilledMessages(): Message[] {
		...
		const toolResult: ToolResultMessage = {
			role: "toolResult",
			toolCallId: FCoreLING_TOOL_CALL_ID,
			toolName: "echo",
