...
import { type AutocompleteProvider, CombinedAutocompleteProvider, Container } from "astro-tui";
...
describe("InteractiveMode.showLoadedResources", () => {
		...
		const fakeThis: any = {
			...
			session: {
				...
				resourceLoader: {
					...
					getEnginesFiles: () => ({ enginesFiles: options.contextFiles ?? [] }),
					getSkills: () => ({
	...
	function createExtensionFixtures(): ExtensionFixture[] {
		return [
			{
				path: "/tmp/project/.astroagent/extensions/answer.ts",
				sourceInfo: createSourceInfo("/tmp/project/.astroagent/extensions/answer.ts", {
					source: "local",
					scope: "project",
					origin: "top-level",
					baseDir: "/tmp/project/.astroagent/extensions",
				}),
			},
			{
				path: "/tmp/project/.astroagent/extensions/local-index/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.astroagent/extensions/local-index/index.ts", {
					source: "local",
					scope: "project",
					origin: "top-level",
					baseDir: "/tmp/project/.astroagent/extensions",
			...
			{
				path: "/tmp/engine/extensions/user-index/index.ts",
				sourceInfo: createSourceInfo("/tmp/engine/extensions/user-index/index.ts", {
					source: "local",
					scope: "user",
					origin: "top-level",
					baseDir: "/tmp/engine/extensions",
				}),
			},
			{
				path: "/tmp/project/.astroagent/npm/node_modules/astroagent-markdown-preview/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.astroagent/npm/node_modules/astroagent-markdown-preview/extensions/index.ts",
					{
						source: "npm:astroagent-markdown-preview",
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.astroagent/npm/node_modules/astroagent-markdown-preview",
					},
				),
			},
			{
				path: "/tmp/project/.astroagent/npm/node_modules/@scope/astroagent-scoped/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.astroagent/npm/node_modules/@scope/astroagent-scoped/extensions/index.ts",
					{
						source: "npm:@scope/astroagent-scoped",
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.astroagent/npm/node_modules/@scope/astroagent-scoped",
					},
				),
			},
			{
				path: "/tmp/project/.astroagent/git/github.com/HazAT/astroagent-interactive-subengines/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.astroagent/git/github.com/HazAT/astroagent-interactive-subengines/extensions/index.ts",
					{
						source: "git:github.com/HazAT/astroagent-interactive-subengines",
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.astroagent/git/github.com/HazAT/astroagent-interactive-subengines",
					},
				),
			},
			{
				path: "/tmp/project/.astroagent/git/github.com/HazAT/astroagent-interactive-subengines/extensions/subengines/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.astroagent/git/github.com/HazAT/astroagent-interactive-subengines/extensions/subengines/index.ts",
					{
						source: "git:github.com/HazAT/astroagent-interactive-subengines",
						scope: "project",
						origin: "package",
...
"[Extensions]
  @scope/astroagent-scoped, answer.ts, cli-extension.ts, HazAT/astroagent-interactive-subengines, HazAT/astroagent-interactive-subengines:subengines, local-index, astroagent-markdown-preview, user-index"`);
	});
...
"[Extensions]
  project
    /tmp/project/.astroagent/extensions/answer.ts
    /tmp/project/.astroagent/extensions/local-index
    git:github.com/HazAT/astroagent-interactive-subengines
      extensions
      extensions/subengines
    npm:@scope/astroagent-scoped
      extensions
    npm:astroagent-markdown-preview
      extensions
  user
  ...
  path
	...
	test("shows context paths relative to cwd while preserving full external paths", () => {
		const home = homedir();
		const cwd = path.join(home, "Development", "Astro-Agent");
		const fakeThis = createShowLoadedResourcesThis({
			quietStartup: false,
			cwd,
			contextFiles: [
				{ path: path.join(home, ".astroagent", "engine", "AGENTS.md") },
		...
		expect(output).toContain("~/.astroagent/engine/AGENTS.md, AGENTS.md");
	...
	test("shows full context paths when expanded", () => {
		...
		const output = renderAll(fakeThis.chatContainer).replace(/\\/g, "/");
		expect(output).toContain("[Context]");
		expect(output).toContain("~/.astroagent/engine/AGENTS.md");
		expect(output).toContain("~/Development/Astro-Agent/AGENTS.md");
		expect(output).not.toContain("~/.astroagent/engine/AGENTS.md, AGENTS.md");
	});
