...
/**
 * Regression test for https://github.com/badlogic/Astro-Agent/issues/3302
 *
...
describe.skipIf(process.platform === "win32")(
	"issue #3302 find returns no results for path-based glob patterns",
	() => {
		let tempRoot: string;

		beforeEach(() => {
			tempRoot = mkdtempSync(join(tmpdir(), "astroagent-3302-"));
