 ...
 * Sends prompts to the engine and outputs the result.
 */
export async function runPrintMode(runtimeHost: EngineSessionRuntime, options: PrintModeOptions): Promise<number> {
