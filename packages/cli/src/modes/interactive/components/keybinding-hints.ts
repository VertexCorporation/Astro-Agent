...
import { getKeybindings, type Keybinding, type KeyId } from "astro-tui";
import { theme } from "../theme/theme.js";

const OS = typeof process !== "undefined" && process.platform === "win32" ? "win32" : typeof process !== "undefined" ? process.platform : "linux";
...
function formatKeyPart(part: string, options: KeyTextFormatOptions): string {
	const displayPart = OS === "darwin" && part.toLowerCase() === "alt" ? "option" : part;
