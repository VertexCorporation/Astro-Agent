// @ts-nocheck
import { Container, matchesKey, Spacer, Text } from "astro-tui";
...
export class AppLockComponent extends Container {
	constructor(
		...
		// Title
		this.addChild(new Text(theme.fg("accent", theme.bold("  🔒 Astro-Agent WEB ARAYÜZÜ AKTİF")), 0, 0));
		this.addChild(new Spacer(1));

		// Description
		this.addChild(new Text("  TUI geçici olarak kilitlendi. Astro-Agent'u tarayıcınızdan", 0, 0));
