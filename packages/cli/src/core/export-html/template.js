    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="Astro-Agent-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="Astro-Agent-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'Astro-Agent-share:v1:sidebar-width';
