 ...
 * Used by engine-session to pre-render extension tool output.
 */
...
function generateHtml(sessionData: SessionData, themeName?: string): string {
	...
	const css = templateCss
		...
		.replace("{{CONTCoreNER_BG}}", containerBg)
...
/**
 * Export session to HTML using SessionManager and EngineState.
...
/**
 * Export session file to HTML (standalone, without EngineState).
