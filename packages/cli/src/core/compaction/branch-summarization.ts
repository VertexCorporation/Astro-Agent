...
export interface GenerateBranchSummaryOptions {
	...
	/** Tokens reserved for prompt + Provider response (default 16384) */
...
/**
 * Extract EngineMessage from a session entry.
...
export async function generateBranchSummary(
	...
	// Transform to Provider-compatible messages, then serialize to text
