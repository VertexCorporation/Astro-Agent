...
const GITHUB_REPO = "VertexCorporation/Astro-Agent";
const CHANGELOG_LINK_BASE_PATH = "packages/cli";
const LEGACY_REPO_RE = /^https:\/\/github\.com\/(?:VertexCorporation)\/Astro-Agent-mono(?=\/|$)/;
